...
public class ExerciseProgress6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_progress6);
        Intent i = getIntent();
    ...
    public void nextExercise(View v){
        ...
        Intent i = new Intent(this, ExerciseProgress7.class);
