...
public class ExerciseProgress3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_progress3);
        Intent i = getIntent();
    ...
    public void nextExercise(View v){
        ...
        Intent i = new Intent(this, ExerciseProgress4.class);
