...
public class ExerciseProgress4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_progress4);
        Intent i = getIntent();
    ...
    public void nextExercise(View v){
        ...
        Intent i = new Intent(this, ExerciseProgress5.class);
